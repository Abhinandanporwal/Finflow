  ...
  <DrawerContent>
    ...
    <div className='px-4 py-4'>
        ...
        <div className='space-y-2 '>
            <label htmlFor="name" className='test-sm font-medium'>Account Name</label>
        ...
        <div className='space-y-2 '>
            <label htmlFor="type" className='test-sm font-medium'>Account Type</label>
        ...
        <div className='space-y-2 '>
            <label htmlFor="balance" className='test-sm font-medium'>Account Balance</label>
        ...
        <div className='flex items-center justify-between rounded-lg border p-3 '>
            ...
            <label htmlFor="isDefault" className='test-sm font-medium cursor-pointer'>Set AS Default</label>
